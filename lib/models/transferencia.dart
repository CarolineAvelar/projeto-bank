// classe que representa uma transferência no projeto bank.
...
class Transferencia {
  ...
  // factory constructor usado para criar um objeto Transferencia
  ...
  factory Transferencia.fromJson(Map<String, dynamic> json) {
    ...
    // retorna um novo objeto Transferencia preenchido
  ...
  // método usado para converter um objeto Transferencia em Map.
  //
